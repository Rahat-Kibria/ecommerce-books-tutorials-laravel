        ...
        <div class="tab-content" id="myaccountContent">
            ...
            <div id="orders">
                <div class="myaccount-content">
                    ...
                    <div class="track">
                        <div class="step @if ($order->is_cancelled == 'no') active @endif"> <span class="icon"> <i
                                    class="fa fa-check"></i>
                            </span> <span class="text">Order confirmed</span> </div>
                        <div class="step @if ($order->is_seen_by_admin == 'yes') active @endif"> <span class="icon"> <i
                                    class="fa fa-user"></i>
                            </span> <span class="text"> Processing</span> </div>
                        <div class="step @if ($order->is_out_for_delivery == 'yes') active @endif"> <span class="icon"> <i
                                    class="fa fa-truck"></i> </span>
                            <span class="text"> On the way </span>
                        </div>
                        <div class="step @if ($order->is_completed == 'yes') active @endif"> <span class="icon"> <i
                    ...
                    <div class="myaccount-table table-responsive text-center">
                        <table class="table table-bordered">
                            <thead class="thead-light">
                                <tr>
                                    <th colspan='2' style="font-size: 1.5rem; text-transform: uppercase;">Products
                                        Summery
                                    </th>
