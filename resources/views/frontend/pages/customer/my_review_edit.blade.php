        ...
        <div class="tab-content" id="myaccountContent">
            ...
            <div id="reviewsratings">
                <div class="myaccount-content">
                    <h2 class="title-lg mb--20 pt--15">EDIT REVIEW</h2>
                    @php
                    ...
                    <div class="rating-row pt-2">
                        ...
                        @if ($errors->has('rating'))
                            ...
                            @endforeach
                        @endif
                        <form action="{{ route('botu.account.my_review.update', $product_review->id) }}"
                            class="mt--15 site-form " id="review_rating_form" method="post">
                            @csrf
                            @method('put')
                            <div class="row">
                                <div class="col-7">
                                    <div class="form-group">
                                        ...
                                        <textarea name="message" id="message" cols="30" rows="10" class="form-control" required>{{ $product_review->message }}</textarea>
                                    </div>
                                ...
                                <div class="col-lg-12">
                                    <div class="submit-btn">
                                        <button type="submit" class="btn btn-black">Update Comment</button>
                                    </div>
                                </div>
                            </div>
                        </form>
