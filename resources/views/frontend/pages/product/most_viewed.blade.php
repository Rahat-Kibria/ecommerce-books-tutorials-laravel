            ...
            <div class="breadcrumb-contents">
                <nav aria-label="breadcrumb">
                    <ol class="breadcrumb">
                        ...
                        <li class="breadcrumb-item active">Most Viewed</li>
                    </ol>
                </nav>
            </div>
        </div>
        ...
        <div class="container">
            <div class="row">
                <div class="col-lg-9 order-lg-2">
                        ...
                        <div class="row align-items-center">
                            ...
                            <div class="col-xl-4 col-md-4 col-sm-6  mt--10 mt-sm--0">
                                <span class="toolbar-status">
                                    Showing {{ $most_viewed_products->firstItem() }} to
                                    {{ $most_viewed_products->lastItem() }} of
                                    {{ $most_viewed_products->total() }}
                                    ({{ $most_viewed_products->lastPage() }} Pages)
                                </span>
                            </div>
                                    ...
                                    <div class="product-grid-content">
                                        ...
                                        <div class="product-card--body">
                                            <div class="card-image">
                                                @php
                                                    $product_image = json_decode($most_viewed_product->image);
                                                @endphp
                                                ...
                                                <div class="hover-contents">
                                                    <a href="{{ route('botu.product.details', [$most_viewed_product->id, $most_viewed_product->slug]) }}"
                                                        class="hover-image">
                                                        @if (!empty($product_image[0]))
                                                            <img src="{{ url('/uploads/product_images/' . $product_image[0]) }}"
                                                                height="220" width="220" alt="Product Image">
                                                    ...
                                                    <div class="hover-btns">
                                                        <form
                                                            action="{{ route('botu.add_to_cart', $most_viewed_product->id) }}"
                                                            method="post">
                                                            @csrf
                                                        ...
                                                        <form
                                                            action="{{ route('botu.add_to_wishlist', $most_viewed_product->id) }}"
                                                            method="post">
                                                            @csrf
                                                            <button type="submit" class="single-btn">
                                                        ...
                                                        <a data-toggle="modal" class="single-btn product_details_modal"
                                                            data-id="{{ $most_viewed_product->id }}"
                                                            data-name="{{ $most_viewed_product->name }}"
                                                            data-author="{{ $most_viewed_product->author }}"
                                                            data-image="{{ $most_viewed_product->image }}"
                                                            data-stock-status="{{ $most_viewed_product->stock_status }}"
                                                            data-price="{{ $most_viewed_product->price }}"
                                                            data-discount="{{ $most_viewed_product->discount }}"
                                                            data-short-description="{{ $most_viewed_product->short_description }}">
                                            ...
                                            <div class="price-block">
                                                ...
                                                <del class="price-old">৳{{ $most_viewed_product->price }}</del>
                                                <span class="price-discount">{{ $most_viewed_product->discount }}%</span>
                                            </div>
                                        </div>
                                    </div>
                                </div>
                    ...
                    @if ($most_viewed_products->isEmpty())
