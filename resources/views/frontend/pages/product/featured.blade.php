                        ...
                        <div class="row align-items-center">
                            ...
                            <div class="col-xl-4 col-md-4 col-sm-6  mt--10 mt-sm--0">
                                <span class="toolbar-status">
                                    Showing {{ $featured_products->firstItem() }} to
                                    {{ $featured_products->lastItem() }} of
                                    {{ $featured_products->total() }}
                                    ({{ $featured_products->lastPage() }} Pages)
                                </span>
                            </div>
                                    ...
                                    <div class="product-grid-content">
                                        ...
                                        <div class="product-card--body">
                                            <div class="card-image">
                                                @php
                                                    $product_image = json_decode($featured_product->image);
                                                @endphp
                                                ...
                                                <div class="hover-contents">
                                                    <a href="{{ route('botu.product.details', [$featured_product->id, $featured_product->slug]) }}"
                                                        class="hover-image">
                                                        @if (!empty($product_image[0]))
                                                            <img src="{{ url('/uploads/product_images/' . $product_image[0]) }}"
                                                                height="220" width="220" alt="Product Image">
                                                    ...
                                                    <div class="hover-btns">
                                                        <form
                                                            action="{{ route('botu.add_to_cart', $featured_product->id) }}"
                                                            method="post">
                                                            @csrf
                                                        ...
                                                        <form
                                                            action="{{ route('botu.add_to_wishlist', $featured_product->id) }}"
                                                            method="post">
                                                            @csrf
                                                            <button type="submit" class="single-btn">
                                                        ...
                                                        <a data-toggle="modal" class="single-btn product_details_modal"
                                                            ...
                                                            data-author="{{ $featured_product->author }}"
                                                            data-image="{{ $featured_product->image }}"
                                                            data-stock-status="{{ $featured_product->stock_status }}"
                                                            data-price="{{ $featured_product->price }}"
                                                            data-discount="{{ $featured_product->discount }}"
                                                            data-short-description="{{ $featured_product->short_description }}">
                                            ...
                                            <div class="price-block">
                                                ...
                                                <span class="price-discount">{{ $featured_product->discount }}%</span>
                                            </div>
                                        </div>
                                    </div>
                                </div>
