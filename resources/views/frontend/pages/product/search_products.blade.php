            ...
            <div class="row">
                <div class="col-lg-9 order-lg-2">
                        ...
                        <div class="row align-items-center">
                            ...
                            <div class="col-xl-4 col-md-4 col-sm-6  mt--10 mt-sm--0">
                                <span class="toolbar-status">
                                    Showing {{ $searchResult->firstItem() }} to {{ $searchResult->lastItem() }} of
                                    {{ $searchResult->total() }}
                                    ({{ $searchResult->lastPage() }} Pages)
                                </span>
                            </div>
                    ...
                    <div class="shop-product-wrap grid with-pagination row space-db--30 shop-border">
                        ...
                        @forelse ($searchResult as $product)
                            <div class="col-lg-4 col-sm-6">
                                <div class="product-card">
                                    <div class="product-grid-content">
                                        <div class="product-header">
                                            <a href="{{ route('botu.author.instructor', $product->author) }}" class="author">
                                                {{ $product->author }}
                                            </a>
                                            <h3>
                                            ...
                                            <div class="card-image">
                                                ...
                                                @if (!empty($product_image[0]))
                                                    <img src="{{ url('/uploads/product_images/' . $product_image[0]) }}"
                                                        style="height: 220px; width: 220px" alt="Product Image">
                                                @else
                                                ...
                                                <div class="hover-contents">
                                                    ...
                                                    @else
                                                        <a href="{{ route('botu.tutorial.details', [$product->id, $product->slug]) }}"
                                                            class="hover-image">
                                                            @if (!empty($product_image[0]))
                                                                <img src="{{ url('/uploads/product_images/' . $product_image[0]) }}"
                                                                    style="height: 220px; width: 220px"
