...
<head>
    ...
    <title>Order delivery attempt failed</title>
</head>
...
<body style="background-color: #fff; font-family: Verdana, Geneva, Tahoma, sans-serif;">
    <div style="width: 60%; margin: auto; border: 1px solid #ddd;">
        <div style="background-color: #62ab00; padding: 30px;">
            <h1>Your order #{{ $order->id }} delivery attempt failed</h1>
        </div>
        <div style="padding: 30px;">
            <p>Hi {{ $user->first_name }},</p>
            <p>Your order no # {{ $order->id }} delivery attempt failed. If Allah wills, We will try again soon.</p>
            <p>Happy Shopping.</p>
