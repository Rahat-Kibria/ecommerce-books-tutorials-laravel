...
<head>
    ...
    <title>Order has been completed successfully</title>
</head>
...
<body style="background-color: #fff; font-family: Verdana, Geneva, Tahoma, sans-serif;">
    <div style="width: 60%; margin: auto; border: 1px solid #ddd;">
        <div style="background-color: #62ab00; padding: 30px;">
            <h1>Your order #{{ $order->id }} has been completed successfully</h1>
        </div>
        <div style="padding: 30px;">
            <p>Hi {{ $user->first_name }},</p>
            <p>Your order no # {{ $order->id }} has been completed successfully.</p>
            <p>Happy Shopping.</p>
