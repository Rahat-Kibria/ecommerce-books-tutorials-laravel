        ...
        <div class="max-w-6xl mx-auto sm:px-6 lg:px-8">
            <div style="text-align: center;">
                <a href="{{ route('admin.dashboard') }}"
                    style="background:#EF3B2D; padding: 20px; color:white; border-radius:30px;">Back to
                    Admin</a>
                <a href="{{ route('botu') }}"
                    style="background:#EF3B2D; margin-left:50px; padding: 20px; color:white; border-radius:30px;">Back
                    to
                    Website</a>
            </div>
