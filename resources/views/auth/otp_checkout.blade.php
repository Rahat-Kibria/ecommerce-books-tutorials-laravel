...
<body>
    ...
    @endif
    <form action="{{ route('botu.otp.in.checkout') }}" method="POST">
        @csrf
        <div class="container" style="width: 30%; margin-top: 8%; background-color: #fff;">
            <div class="pb-3 text-center">
                <h3>Confirm OTP</h3>
                <p>Please enter your otp sent to your contact number</p>
            </div>
            <div class="pb-3 text-center">
                <label for="otp" class="form-label" style="font-weight:bold; font-size:1.3rem;">OTP</label>
                <input type="text" class="form-control" name="otp" id="otp" placeholder="Type OTP here">
                <input type="hidden" name="user_id" value="{{ $user_id }}">
                <input type="hidden" name="message" value="{{ $order_message }}">
