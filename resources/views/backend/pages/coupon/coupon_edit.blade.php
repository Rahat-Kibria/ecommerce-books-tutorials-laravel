...
@section('content')
    <div class="mt-3" style="width: 35%; padding-left: 10px;">
        <h3 class="alert alert-success">Admin > Edit Coupon</h3>
    </div>
        ...
        <form action="{{ route('admin.coupon.update', $coupon->id) }}" method="POST">
            ...
            <fieldset class="form-group border" style="background-color: #CEFAD0;">
                ...
                <div class="form-group mb-3">
                    ...
                    <input type="text" name="slug" id="slug" value="{{ $coupon->slug }}" class="form-control"
                        required>
                    @if ($errors->has('slug'))
                ...
                <div class="form-group mb-3">
                    ...
                    <input type="datetime-local" name="expiry_date" id="expiry_date" value="{{ $coupon->expiry_date }}"
                        class="form-control" {{-- min="Carbon\Carbon::now() }}" --}} required>
