                        ...
                        <div class="col-md-6 m-auto">
                            <div class="coupon p-4">
                                ...
                                <div class="sizes mt-2">
                                    <h4 class="text-uppercase d-inline">Code:</h4>
                                    <span>{{ $coupon->code }}</span>
                                </div>
                                <div class="sizes mt-2">
                                    <h6 class="text-uppercase d-inline">Slug:</h6>
                                    <span>{{ $coupon->slug }}</span>
                                </div>
                                <div class="sizes mt-2">
                                    <h5 class="text-uppercase d-inline">Expiry Date:</h5>
                                    <span>{{ $coupon->expiry_date }}</span>
                                </div>
                                <div class="sizes my-3">
                                    <h5 class="text-uppercase d-inline">Discount:</h5>
