...
@section('content')
    <div class="mt-3" style="width: 35%; padding-left: 50px;">
        <h3 class="alert alert-success">Admin > Edit Feedback</h3>
    </div>
            ...
            <fieldset class="form-group border" style="background-color: #CEFAD0;">
                ...
                <div class="form-group mb-3">
                    ...
                    <select name="status" id="status" class="form-control">
                        <option @if ($feedback->status == 'pending') selected @endif value="pending" default>Pending</option>
                        <option @if ($feedback->status == 'seen') selected @endif value="seen">Seen</option>
                        <option @if ($feedback->status == 'solved') selected @endif value="solved">Solved</option>
                    </select>
