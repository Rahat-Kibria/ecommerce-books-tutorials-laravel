...
@section('content')
    <div class="mt-3" style="width: 35%; padding-left: 10px;">
        <h3 class="alert alert-success">Admin > Add an Ebook</h3>
    </div>
    ...
    <div style="padding: 10px;">
        <form action="{{ route('admin.ebook.store') }}" method="POST" enctype="multipart/form-data">
            ...
            <fieldset class="form-group border" style="background-color: #CEFAD0;">
                <legend class="w-auto">Ebook Form</legend>
                ...
                <div class="form-group mb-3">
                    <label for="ebook" class="form-label">Pick a PDF File<span style="color: red;">*</span></label>
                    <input type="file" id="ebook" class="form-control" name="ebook" accept="application/pdf">
                    @if ($errors->has('ebook'))
